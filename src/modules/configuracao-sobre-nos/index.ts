  ...
  .patch('/edit/', async ({ body, set, cookie, jwt, getAuthUser, verificaPermissao }) : Promise<APIResponse | APIResponseError> => {
  ...
  },
    {
      ...
      body: t.Object({
        ...
        horarioSegundaAbertura: t.Optional(t.String({ default: '08:00' })),
        horarioSegundaFechamento: t.Optional(t.String({ default: '18:00' })),
        tercaLaboratorioAbre: t.Optional(t.Boolean()),
        horarioTercaAbertura: t.Optional(t.String({ default: '08:00' })),
        horarioTercaFechamento: t.Optional(t.String({ default: '18:00' })),
        quartaLaboratorioAbre: t.Optional(t.Boolean()),
        horarioQuartaAbertura: t.Optional(t.String({ default: '08:00' })),
        horarioQuartaFechamento: t.Optional(t.String({ default: '18:00' })),
        quintaLaboratorioAbre: t.Optional(t.Boolean()),
        horarioQuintaAbertura: t.Optional(t.String({ default: '08:00' })),
        horarioQuintaFechamento: t.Optional(t.String({ default: '18:00' })),
        sextaLaboratorioAbre: t.Optional(t.Boolean()),
        horarioSextaAbertura: t.Optional(t.String({ default: '08:00' })),
        horarioSextaFechamento: t.Optional(t.String({ default: '18:00' })),
        sabadoLaboratorioAbre: t.Optional(t.Boolean()),
        horarioSabadoAbertura: t.Optional(t.String({ default: '08:00' })),
        horarioSabadoFechamento: t.Optional(t.String({ default: '18:00' })),
        domingoLaboratorioAbre: t.Optional(t.Boolean()),
        horarioDomingoAbertura: t.Optional(t.String({ default: '08:00' })),
        horarioDomingoFechamento: t.Optional(t.String({ default: '18:00' })),
      }),
      detail: { 
